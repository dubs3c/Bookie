...
class TelegramApiTestCase(TestCase):
        ...
        self.telegram_request = {
            "message": {
                ...
                "photo": list(
                    [
                        {
                            "file_id": "afhaugafagageg",
                            "file_size": 1432,
                            "height": 90,
                            "width": 67,
                        },
                        {
                            "file_id": "figjopsrjgklnvsouhrog",
                            "file_size": 16149,
                            "height": 320,
                            "width": 240,
                        },
                        {
                            "file_id": "fjfoishrgouggea",
                            "file_size": 73321,
                            "height": 800,
                            "width": 601,
                        },
                        {
                            "file_id": "fkskafjgishgousofgsg",
                            "file_size": 120691,
                            "height": 1280,
                            "width": 962,
                        },
    ...
    def test_register_telegram_account(self, mock_requests):
        ...
        obj = Telegram.objects.create(
            user=self.user, telegram_username="dabookieman", token="1234"
        )
        ...
        with mock.patch("utils.telegram.send_message") as mock_send:
            ...
            response = self.client.post(
                self.telegram_api, data, content_type="application/json"
            )
    ...
    def test_register_telegram_account_no_token(self, mock_send, mock_requests):
        ...
        mock_send.assert_called_with(
            self.telegram_request["message"]["chat"]["id"],
            "You forgot to enter your code...",
        )
    ...
    @mock.patch("requests.Session.post")
    @mock.patch("apps.api.views.send_message")
    def test_register_telegram_account_token_already_activated(
        self, mock_send, mock_requests
    ):
    ...
    def test_add_bookmarks(self, mock_send, mock_requests, mock_parse_article):
        ...
        mock_requests.return_value.status_code = 200
        mock_send.return_value = (True, "Success")
        mock_parse_article.return_value = {
