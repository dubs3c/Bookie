...
class SettingsTestCase(TestCase):
    ...
    def test_change_password(self):
        ...
        self.assertEqual(
            check_password("1234", Profile.objects.get(username="tester").password),
            True,
        )
    ...
    def test_change_pasword_wrong_password_fail(self):
        ...
        self.assertEqual(
            check_password("asdf", Profile.objects.get(username="tester").password),
            True,
        )
    ...
    def test_change_password_mismatch_fail(self):
        ...
        self.assertContains(
            response, "The new password did not match the verification password."
        )
        self.assertEqual(
            check_password("asdf", Profile.objects.get(username="tester").password),
            True,
    ...
    def test_update_profile_fail(self):
        ...
        self.assertContains(
            response,
            f"Select a valid choice. {data['timezone']} is not one of the available choices.",
        )
