...
class FormTestCase(TestCase):
    ...
    def setUp(self):
        self.user = Profile.objects.create(username="tester", password=make_password("asdf"),
    ...
    def test_change_passwords_invalid(self):
        ...
        data = {"old_password": "asdf", "new_password1": "ERROR", "new_password2": "1234"}
        form = ChangePasswordForm(data=data, user=self.user)

        self.assertFalse(form.is_valid())

        data = {"old_password": "asdf", "new_password1": "1234", "new_password2": "ERROR"}
        form = ChangePasswordForm(data=data, user=self.user)
